...
export class VtexLicenseManagerApiApi implements ICredentialType {
	name = 'N8nDevVtexLicenseManagerApiApi';

	displayName = 'vtex-license-manager-api API';

	icon: Icon = { light: 'file:../nodes/VtexLicenseManagerApi/vtex-license-manager-api.svg', dark: 'file:../nodes/VtexLicenseManagerApi/vtex-license-manager-api.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your vtex-license-manager-api API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
